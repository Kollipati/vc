          ...
          var r = function() {
              ...
              function i(t) {
                  t.src && !t.classList.contains("lightense-target") && (t.classList.add("lightense-target"), t.addEventListener("click", function(e) {
                      return w.keyboard && (e.metaKey || e.ctrlKey) ? y.open(t.src, "_blank") : void
                      function(e) {
                          if (w.target = e, w.target.classList.contains("lightense-open")) return a();
                          r("beforeShow"), w.scrollY = y.scrollY,
                              function(n, r, i) {
                          ...
                          t.onload = function() {
                              ...
                              function() {
                                  w.target.classList.add("lightense-open"), w.wrap = v.createElement("div"), w.wrap.className = "lightense-wrap", setTimeout(function() {
                                      w.target.style.transform = "scale(" + w.scaleFactor + ")"
                                  }, 20), w.target.parentNode.insertBefore(w.wrap, w.target), w.wrap.appendChild(w.target), setTimeout(function() {
                                  ...
                                  var e = {
                                      ...
                                      t = l(l({}, w), e);
                                  o("lightense-images-css-computed", "\n    :root {\n      --lightense-z-index: ".concat(t.zIndex - 1, ";\n      --lightense-backdrop: ").concat(t.background, ";\n      --lightense-duration: ").concat(t.time, "ms;\n      --lightense-timing-func: ").concat(t.cubicBezier, ";\n    }")), w.container.style.visibility = "visible", setTimeout(function() {
                                      w.container.style.opacity = "1"
                                  }, 20)
                              }(), y.addEventListener("keyup", s, !1), y.addEventListener("scroll", c, !1), w.container.addEventListener("click", a, !1)
                          }, t.src = w.target.src
                      }(this)
                  }, !1))
              }
              ...
              function a() {
                  r("beforeHide"), y.removeEventListener("keyup", s, !1), y.removeEventListener("scroll", c, !1), w.container.removeEventListener("click", a, !1), w.target.classList.remove("lightense-open"), w.wrap.style.transform = "", w.target.style.transform = "", w.target.classList.add("lightense-transitioning"), w.container.style.opacity = "", setTimeout(function() {
                      r("afterHide"), w.container.style.visibility = "", w.container.style.backgroundColor = "", w.wrap.parentNode.replaceChild(w.target, w.wrap), w.target.classList.remove("lightense-transitioning")
                  }, w.time)
              }
